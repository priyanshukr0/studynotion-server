...
exports.createCourse = async (req, res) => {
	try {
		...
		console.error('error occured while creating course', error);
		res.status(500).json({
			success: false,
...
exports.getCourseDetails = async (req, res) => {
	try {
		...
		console.log('error occured while fetching course',error);
		return res.status(404).json({
			success: false,
			message: `Can't Fetch Course Data`,
			error: error.message
...
exports.editCourse = async (req, res) => {
	try {
		...
		if (req.files) {
			console.log("upadating course thumbnail")
			const thumbnail = req.files.thumbnailImage
			const thumbnailImage = await uploadImageToCloudinary(
				thumbnail,
				process.env.FOLDER_NAME
...
exports.deleteCourse = async (req, res) => {
	try {
		...
		console.error('Error occured while deleting the course: ',error); 
		return res.status(500).json({
			success: false,
